...
public class Protocol_Const  {
    /*
        Protocol을 통한 통신을 위해 각종 constant 변수들의 정보를 저장한 클래스
     */
    // =====================================================================================
    //데이터 길이에 관한 변수
    ...
    public static final byte 코드_교수요청_교과목정보조회_전체 = 0x30;
    public static final byte 코드_교수요청_교과목정보조회_1학년 = 0x31;
    public static final byte 코드_교수요청_교과목정보조회_2학년 = 0x32;
    public static final byte 코드_교수요청_교과목정보조회_3학년 = 0x33;
    public static final byte 코드_교수요청_교과목정보조회_4학년 = 0x34;
    ...
    public static final byte 코드_정보전송__강의계획서기간정보_시작및종료기간 = 0x22;
